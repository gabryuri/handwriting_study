...
parser.add_argument('-o', '--out', default='./output/processed', help='path to output directory', metavar='DIR')
...
parser.add_argument('--seed', default=30, type=int, help='seed for random number generator, used if specified', metavar='VAL')
